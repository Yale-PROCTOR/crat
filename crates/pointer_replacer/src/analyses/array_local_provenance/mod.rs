...
pub use crate::analyses::pointer_flow::slots::{
    QualifierKey, SlotIdx, SlotInfo, SlotPathElem, SlotTable,
};
use crate::{
    analyses::{
        ...
        pointer_flow::slots::{
            count_slots, slot_path_from_place, slot_path_from_projection, slot_ty,
        },
