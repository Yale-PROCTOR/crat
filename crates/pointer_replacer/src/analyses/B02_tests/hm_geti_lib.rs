...
pub mod src {
    pub mod lib {
        ...
        pub const STBDS_HM_BINARY: core::ffi::c_int = 0 as core::ffi::c_int;
        pub const STBDS_HM_STRING: core::ffi::c_int = 1 as core::ffi::c_int;
        pub const __ASSERT_FUNCTION_0: [core::ffi::c_char; 18] = [
            b'v' as i8,
            b'o' as i8,
            b'i' as i8,
            b'd' as i8,
        ...
        unsafe extern "C" fn stbds_make_hash_index(
                ...
                < (*t).slot_count
            {
                ...
                __assert_fail(b"t->used_count_threshold + t->tombstone_count_threshold < t->slot_count\0"
                    ...
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
        ...
        unsafe extern "C" fn stbds_siphash_bytes(
                ...
                7 => {
                    data = (data as core::ffi::c_ulong
                        | (((*d.offset(6 as core::ffi::c_int as isize) as size_t)
                            ...
                            << 24 as core::ffi::c_int)
                            as core::ffi::c_ulong) as size_t;
                    current_block_40 = 8615545881852380985;
                }
                6 => {
                    current_block_40 = 8615545881852380985;
                }
                5 => {
                    current_block_40 = 9944861384781218757;
                }
                4 => {
                    current_block_40 = 4069628245460391273;
                }
                3 => {
                    current_block_40 = 11763560597460547600;
                }
                2 => {
                    current_block_40 = 13805756004888782123;
                }
                1 => {
                    current_block_40 = 15461180760796017574;
                }
                0 | _ => {
                    current_block_40 = 1538046216550696469;
                }
            }
            if current_block_40 == 8615545881852380985 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 9944861384781218757 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 4069628245460391273 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(3 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 11763560597460547600 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(2 as core::ffi::c_int as isize) as core::ffi::c_int)
                        << 16 as core::ffi::c_int) as core::ffi::c_ulong)
                    as size_t;
            ...
            if current_block_40 == 13805756004888782123 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(1 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 15461180760796017574 {
                data = (data as core::ffi::c_ulong
        ...
        #[no_mangle]
        pub unsafe extern "C" fn hm_geti(num: core::ffi::c_int) {
            let mut intmap: *mut C2RustUnnamed = std::ptr::null_mut::<C2RustUnnamed>();
            let mut temp: ptrdiff_t = 0;
            ...
            intmap = stbds_hmget_key(
                ...
                [i].as_mut_ptr() as *mut core::ffi::c_void,
                ::core::mem::size_of::<core::ffi::c_int>() as size_t,
                0 as core::ffi::c_int,
            ) as *mut C2RustUnnamed;
            if (*(intmap.offset(-(1 as core::ffi::c_int as isize)) as *mut stbds_array_header)
                .offset(-(1 as core::ffi::c_int as isize)))
            .temp
                == -(1 as core::ffi::c_int) as ptrdiff_t
            {
            } else {
                __assert_fail(b"hmgeti(intmap,i) == -1\0" as *const u8 as
                        *const core::ffi::c_char,
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
                    952 as core::ffi::c_uint, __ASSERT_FUNCTION_0.as_ptr());
            }
            'c_8162: {
                intmap = stbds_hmget_key(
                    intmap as *mut core::ffi::c_void,
            ...
            intmap = stbds_hmput_default(
                intmap as *mut core::ffi::c_void,
                ::core::mem::size_of::<C2RustUnnamed>() as size_t,
            ) as *mut C2RustUnnamed;
            (*intmap.offset(-(1 as core::ffi::c_int) as isize)).value = -(2 as core::ffi::c_int);
            intmap = stbds_hmget_key(
                intmap as *mut core::ffi::c_void,
                ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                [i].as_mut_ptr() as *mut core::ffi::c_void,
                ...
                == -(1 as core::ffi::c_int) as ptrdiff_t
            {
                ...
                __assert_fail(b"hmgeti(intmap, i) == -1\0" as *const u8 as
                    ...
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
                    954 as core::ffi::c_uint, __ASSERT_FUNCTION_0.as_ptr());
            }
            'c_7899: {
                intmap = stbds_hmget_key(
                    intmap as *mut core::ffi::c_void,
            ...
            if (*(&mut *intmap.offset(
                (*(intmap.offset(-(1 as core::ffi::c_int as isize)) as *mut stbds_array_header)
                    .offset(-(1 as core::ffi::c_int as isize)))
                .temp,
            ) as *mut C2RustUnnamed))
                .value
                == -(2 as core::ffi::c_int)
            {
                ...
                __assert_fail(b"hmget (intmap, i) == -2\0" as *const u8 as
                        *const core::ffi::c_char,
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
                    955 as core::ffi::c_uint, __ASSERT_FUNCTION_0.as_ptr());
            }
            'c_7723: {
                intmap = stbds_hmget_key(
                    intmap as *mut core::ffi::c_void,
            ...
            while i < num {
                if i & 1 as core::ffi::c_int != 0 {
                        ...
                        == -(2 as core::ffi::c_int)
                    {
                        ...
                        __assert_fail(b"hmget(intmap, i) == -2\0" as *const u8 as
                            ...
                            b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                                    as *const u8 as *const core::ffi::c_char,
                            959 as core::ffi::c_uint, __ASSERT_FUNCTION_0.as_ptr());
                    }
                    'c_7441: {
                        intmap = stbds_hmget_key(
                            intmap as *mut core::ffi::c_void,
                        ...
                        == i * 5 as core::ffi::c_int
                    {
                        ...
                        __assert_fail(b"hmget(intmap, i) == i*5\0" as *const u8 as
                                *const core::ffi::c_char,
                            b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                                    as *const u8 as *const core::ffi::c_char,
                            960 as core::ffi::c_uint, __ASSERT_FUNCTION_0.as_ptr());
                    }
                    'c_7261: {
                        intmap = stbds_hmget_key(
                            intmap as *mut core::ffi::c_void,
                ...
                if i & 1 as core::ffi::c_int != 0 {
                    ...
                    if (*(&mut *intmap.offset(temp as isize) as *mut C2RustUnnamed)).value
                        == -(2 as core::ffi::c_int)
                    {
                    } else {
                        __assert_fail(b"hmget_ts(intmap, i, temp) == -2\0" as
                                    *const u8 as *const core::ffi::c_char,
                            b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                                    as *const u8 as *const core::ffi::c_char,
                            961 as core::ffi::c_uint, __ASSERT_FUNCTION_0.as_ptr());
                    }
                    'c_7111: {
                        intmap = stbds_hmget_key_ts(
                            intmap as *mut core::ffi::c_void,
                        ...
                        == i * 5 as core::ffi::c_int
                    {
                        ...
                        __assert_fail(b"hmget_ts(intmap, i, temp) == i*5\0" as
                                    *const u8 as *const core::ffi::c_char,
                            b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                                    as *const u8 as *const core::ffi::c_char,
                            962 as core::ffi::c_uint, __ASSERT_FUNCTION_0.as_ptr());
                    }
                    'c_6961: {
                        intmap = stbds_hmget_key_ts(
                            intmap as *mut core::ffi::c_void,
                ...
                if i & 1 as core::ffi::c_int != 0 {
                        ...
                        == -(2 as core::ffi::c_int)
                    {
                        ...
                        __assert_fail(b"hmget(intmap, i) == -2\0" as *const u8 as
                            ...
                            b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                                    as *const u8 as *const core::ffi::c_char,
                            967 as core::ffi::c_uint, __ASSERT_FUNCTION_0.as_ptr());
                    }
                    'c_6670: {
                        intmap = stbds_hmget_key(
                            intmap as *mut core::ffi::c_void,
                        ...
                        == i * 3 as core::ffi::c_int
                    {
                        ...
                        __assert_fail(b"hmget(intmap, i) == i*3\0" as *const u8 as
                                *const core::ffi::c_char,
                            b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                                    as *const u8 as *const core::ffi::c_char,
                            968 as core::ffi::c_uint, __ASSERT_FUNCTION_0.as_ptr());
                    }
                    'c_6490: {
                        intmap = stbds_hmget_key(
                            intmap as *mut core::ffi::c_void,
            ...
            while i < num {
                intmap = stbds_hmdel_key(
                    ...
                    [i].as_mut_ptr() as *mut core::ffi::c_void,
                    ::core::mem::size_of::<core::ffi::c_int>() as size_t,
                    (&mut (*intmap).key as *mut core::ffi::c_int as *mut core::ffi::c_char)
                        .offset_from(intmap as *mut core::ffi::c_char)
                ...
                if i & 3 as core::ffi::c_int != 0 {
                        ...
                        == -(2 as core::ffi::c_int)
                    {
                        ...
                        __assert_fail(b"hmget(intmap, i) == -2\0" as *const u8 as
                            ...
                            b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                                    as *const u8 as *const core::ffi::c_char,
                            972 as core::ffi::c_uint, __ASSERT_FUNCTION_0.as_ptr());
                    }
                    'c_6212: {
                        intmap = stbds_hmget_key(
                            intmap as *mut core::ffi::c_void,
                        ...
                        == i * 3 as core::ffi::c_int
                    {
                        ...
                        __assert_fail(b"hmget(intmap, i) == i*3\0" as *const u8 as
                            ...
                            b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                                    as *const u8 as *const core::ffi::c_char,
                            973 as core::ffi::c_uint, __ASSERT_FUNCTION_0.as_ptr());
                    }
                    'c_6031: {
                        intmap = stbds_hmget_key(
                            intmap as *mut core::ffi::c_void,
            ...
            while i < num {
                    ...
                    == -(2 as core::ffi::c_int)
                {
                    ...
                    __assert_fail(b"hmget(intmap, i) == -2\0" as *const u8 as
                        ...
                        b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/hm_geti_lib/src/hm_geti_lib/test_case/src/lib.c\0"
                                as *const u8 as *const core::ffi::c_char,
                        977 as core::ffi::c_uint, __ASSERT_FUNCTION_0.as_ptr());
                }
                'c_4497: {
                    intmap = stbds_hmget_key(
                        intmap as *mut core::ffi::c_void,
            ...
            if !intmap.is_null() {
                stbds_hmfree_func(
                    intmap.offset(-(1 as core::ffi::c_int as isize)) as *mut core::ffi::c_void,
                    ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                );
            };
            intmap = std::ptr::null_mut::<C2RustUnnamed>();
            i = 0 as core::ffi::c_int;
            while i < num {
                intmap = stbds_hmput_key(
                    intmap as *mut core::ffi::c_void,
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("hm_geti_lib", SOURCE, &[], &[]);
}
