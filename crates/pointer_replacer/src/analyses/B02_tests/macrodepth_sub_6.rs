...
pub mod src {
    pub mod mdcore {
        ...
        pub const INIT_sub: core::ffi::c_int = 0 as core::ffi::c_int;
        #[no_mangle]
        ...
        unsafe extern "C" fn accum_sub(n: core::ffi::c_int) -> core::ffi::c_int {
            let mut acc: core::ffi::c_int = INIT_sub;
            match n {
                1 => {
        ...
        pub unsafe extern "C" fn helper_call(
            ...
            let r: core::ffi::c_int = op_sub(a, b);
            let mut acc: core::ffi::c_int = INIT_sub;
            acc -= 0 as core::ffi::c_int;
            acc -= 1 as core::ffi::c_int;
            acc -= 2 as core::ffi::c_int;
        ...
        pub unsafe extern "C" fn use_generated(n: core::ffi::c_int) -> core::ffi::c_int {
            let r: core::ffi::c_int = accum_sub(n);
            printf(
                b"gen.acc=%d\n\0" as *const u8 as *const core::ffi::c_char,
                r,
            );
    ...
    pub mod mdmain {
        ...
        pub const REPEAT: core::ffi::c_int = 6 as core::ffi::c_int;
        ...
        unsafe fn main_0(
            ...
            let r_call: core::ffi::c_int = op_sub(a, b);
            let mut acc: core::ffi::c_int = INIT_sub;
            acc -= 0 as core::ffi::c_int;
            acc -= 1 as core::ffi::c_int;
            acc -= 2 as core::ffi::c_int;
