...
pub mod src {
    pub mod lib {
        ...
        #[no_mangle]
        pub unsafe extern "C" fn spec_ray(mut cast: *mut c2Raycast,
            mut mp_x: core::ffi::c_float, mut mp_y: core::ffi::c_float,
            mut c_p_x: core::ffi::c_float, mut c_p_y: core::ffi::c_float,
            mut c_r: core::ffi::c_float, mut r_p_x: core::ffi::c_float,
            mut r_p_y: core::ffi::c_float) -> core::ffi::c_int {
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("spec_ray_lib", SOURCE, &[], &[]);
}
