    ...
    pub mod lib {
        ...
        unsafe extern "C" fn stbds_make_hash_index(
                ...
                < (*t).slot_count
            {
                ...
                __assert_fail(b"t->used_count_threshold + t->tombstone_count_threshold < t->slot_count\0"
                    ...
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/arr_del_lib/src/arr_del_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
        ...
        pub unsafe extern "C" fn stbds_hash_string(
            ...
            while *str != 0 {
                ...
                .wrapping_add(fresh19 as core::ffi::c_uchar as size_t);
            }
        ...
        unsafe extern "C" fn stbds_siphash_bytes(
                ...
                7 => {
                    data = (data as core::ffi::c_ulong
                        | (((*d.offset(6 as core::ffi::c_int as isize) as size_t)
                            ...
                            << 24 as core::ffi::c_int)
                            as core::ffi::c_ulong) as size_t;
                    current_block_40 = 5097524147639577748;
                }
                6 => {
                    current_block_40 = 5097524147639577748;
                }
                5 => {
                    current_block_40 = 1302992165486546265;
                }
                4 => {
                    current_block_40 = 3948058512416047487;
                }
                3 => {
                    current_block_40 = 17637474974792487832;
                }
                2 => {
                    current_block_40 = 692111088109024011;
                }
                1 => {
                    current_block_40 = 17714777573885213375;
                }
                0 | _ => {
                    current_block_40 = 1538046216550696469;
                }
            }
            if current_block_40 == 5097524147639577748 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 1302992165486546265 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 3948058512416047487 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(3 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 17637474974792487832 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(2 as core::ffi::c_int as isize) as core::ffi::c_int)
                        << 16 as core::ffi::c_int) as core::ffi::c_ulong)
                    as size_t;
            ...
            if current_block_40 == 692111088109024011 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(1 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 17714777573885213375 {
                data = (data as core::ffi::c_ulong
        ...
        #[no_mangle]
        pub unsafe extern "C" fn arr_del(num: core::ffi::c_int) {
            ...
            while i < 4 as core::ffi::c_int {
                ...
                *arr.add(fresh7) = 4 as core::ffi::c_int;
                memmove(
                    &mut *arr.offset(i as isize) as *mut core::ffi::c_int as *mut core::ffi::c_void,
                ...
                let fresh10 = (*(arr as *mut stbds_array_header)
                    .offset(-(1 as core::ffi::c_int as isize)))
                .length;
                (*(arr as *mut stbds_array_header).offset(-(1 as core::ffi::c_int as isize)))
                    .length = ((*(arr as *mut stbds_array_header)
                ...
                *arr.add(fresh10) = num;
                ...
                let fresh12 = (*(arr as *mut stbds_array_header)
                    .offset(-(1 as core::ffi::c_int as isize)))
                .length;
                (*(arr as *mut stbds_array_header).offset(-(1 as core::ffi::c_int as isize)))
                    .length = ((*(arr as *mut stbds_array_header)
                ...
                .length)
                    .wrapping_add(1);
                *arr.add(fresh12) = 2 as core::ffi::c_int;
                if arr.is_null()
                    || ((*(arr as *mut stbds_array_header)
                        .offset(-(1 as core::ffi::c_int as isize)))
                    .length)
                ...
                let fresh14 = (*(arr as *mut stbds_array_header)
                    .offset(-(1 as core::ffi::c_int as isize)))
                .length;
                (*(arr as *mut stbds_array_header).offset(-(1 as core::ffi::c_int as isize)))
                    .length = ((*(arr as *mut stbds_array_header)
                ...
                .length)
                    .wrapping_add(1);
                *arr.add(fresh14) = 3 as core::ffi::c_int;
                if arr.is_null()
                    || ((*(arr as *mut stbds_array_header)
                        .offset(-(1 as core::ffi::c_int as isize)))
                    .length)
                ...
                let fresh16 = (*(arr as *mut stbds_array_header)
                    .offset(-(1 as core::ffi::c_int as isize)))
                .length;
                (*(arr as *mut stbds_array_header).offset(-(1 as core::ffi::c_int as isize)))
                    .length = ((*(arr as *mut stbds_array_header)
                ...
                .length)
                    .wrapping_add(1);
                *arr.add(fresh16) = 4 as core::ffi::c_int;
                *arr.offset(i as isize) = *arr.add(
                    ((*(arr as *mut stbds_array_header).offset(-(1 as core::ffi::c_int as isize)))
                        .length)
                        .wrapping_sub(1 as size_t),
                );
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("arr_del_lib", SOURCE, &[], &[]);
}
