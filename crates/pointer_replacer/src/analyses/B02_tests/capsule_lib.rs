    ...
    pub mod lib {
        ...
        pub unsafe extern "C" fn capsule(
            ...
            result += c2Collided(
                ...
                C2_TYPE_CIRCLE,
                &mut capsule_in as *mut c2Capsule as *const core::ffi::c_void,
                C2_TYPE_CAPSULE,
            );
            result += c2Collided(
            ...
            result += c2Collided(
                &mut capsule_0 as *mut c2Capsule as *const core::ffi::c_void,
                C2_TYPE_CAPSULE,
                &mut capsule_in as *mut c2Capsule as *const core::ffi::c_void,
                C2_TYPE_CAPSULE,
            ) << 2 as core::ffi::c_int;
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("capsule_lib", SOURCE, &[], &[]);
}
