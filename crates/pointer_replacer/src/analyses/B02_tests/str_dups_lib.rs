...
pub mod src {
    pub mod lib {
        ...
        pub const __ASSERT_FUNCTION: [core::ffi::c_char; 19] = [
            b'v' as i8,
            b'o' as i8,
            b'i' as i8,
            b'd' as i8,
        ...
        unsafe extern "C" fn stbds_make_hash_index(
                ...
                < (*t).slot_count
            {
                ...
                __assert_fail(b"t->used_count_threshold + t->tombstone_count_threshold < t->slot_count\0"
                    ...
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/str_dups_lib/src/str_dups_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
        ...
        pub unsafe extern "C" fn stbds_hash_string(
            ...
            while *str != 0 {
                ...
                .wrapping_add(fresh11 as core::ffi::c_uchar as size_t);
            }
        ...
        unsafe extern "C" fn stbds_siphash_bytes(
                ...
                7 => {
                    data = (data as core::ffi::c_ulong
                        | (((*d.offset(6 as core::ffi::c_int as isize) as size_t)
                            ...
                            << 24 as core::ffi::c_int)
                            as core::ffi::c_ulong) as size_t;
                    current_block_40 = 15225788259906368840;
                }
                6 => {
                    current_block_40 = 15225788259906368840;
                }
                5 => {
                    current_block_40 = 1324721632189282014;
                }
                4 => {
                    current_block_40 = 6461842862752133278;
                }
                3 => {
                    current_block_40 = 13626452593818330011;
                }
                2 => {
                    current_block_40 = 12792103731508134681;
                }
                1 => {
                    current_block_40 = 4549614084285131665;
                }
                0 | _ => {
                    current_block_40 = 1538046216550696469;
                }
            }
            if current_block_40 == 15225788259906368840 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 1324721632189282014 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 6461842862752133278 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(3 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 13626452593818330011 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(2 as core::ffi::c_int as isize) as core::ffi::c_int)
                        << 16 as core::ffi::c_int) as core::ffi::c_ulong)
                    as size_t;
            ...
            if current_block_40 == 12792103731508134681 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(1 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 4549614084285131665 {
                data = (data as core::ffi::c_ulong
        ...
        #[no_mangle]
        pub unsafe extern "C" fn str_dups(num: core::ffi::c_int) {
            let mut strmap: *mut C2RustUnnamed = std::ptr::null_mut::<C2RustUnnamed>();
            let mut s: C2RustUnnamed = C2RustUnnamed {
            ...
            s.key = b"a\0" as *const u8 as *const core::ffi::c_char as *mut core::ffi::c_char;
            s.value = num;
            ...
            strmap = stbds_hmput_key(
                ...
                ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                s.key as *mut core::ffi::c_void,
                ::core::mem::size_of::<*mut core::ffi::c_char>() as size_t,
                STBDS_HM_STRING,
            ) as *mut C2RustUnnamed;
            *strmap.offset(
                (*(strmap.offset(-(1 as core::ffi::c_int as isize)) as *mut stbds_array_header)
                    .offset(-(1 as core::ffi::c_int as isize)))
                .temp,
            ) = s;
            (*strmap.offset(
            ...
            .key = *((*(strmap.offset(-(1 as core::ffi::c_int as isize))
                as *mut stbds_array_header)
                .offset(-(1 as core::ffi::c_int as isize)))
            .hash_table as *mut *mut core::ffi::c_char);
            if *(*strmap.offset(0 as core::ffi::c_int as isize)).key as core::ffi::c_int
                == 'a' as i32
            {
            } else {
                __assert_fail(b"*strmap[0].key == 'a'\0" as *const u8 as
                        *const core::ffi::c_char,
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/str_dups_lib/src/str_dups_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
                    960 as core::ffi::c_uint, __ASSERT_FUNCTION.as_ptr());
            }
            'c_553: {};
            if (*strmap.offset(0 as core::ffi::c_int as isize)).key != s.key {
            } else {
                __assert_fail(b"strmap[0].key != s.key\0" as *const u8 as
                        *const core::ffi::c_char,
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/str_dups_lib/src/str_dups_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
            ...
            'c_504: {};
            if (*strmap.offset(0 as core::ffi::c_int as isize)).value == s.value {
            } else {
                __assert_fail(b"strmap[0].value == s.value\0" as *const u8 as
                        *const core::ffi::c_char,
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/str_dups_lib/src/str_dups_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
                    962 as core::ffi::c_uint, __ASSERT_FUNCTION.as_ptr());
            }
            'c_443: {};
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("str_dups_lib", SOURCE, &[], &[]);
}
