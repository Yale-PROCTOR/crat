    ...
    pub mod lib {
        ...
        unsafe extern "C" fn stbds_make_hash_index(
                ...
                < (*t).slot_count
            {
                ...
                __assert_fail(b"t->used_count_threshold + t->tombstone_count_threshold < t->slot_count\0"
                    ...
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/arr_push_lib/src/arr_push_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
        ...
        pub unsafe extern "C" fn stbds_hash_string(
            ...
            while *str != 0 {
                ...
                .wrapping_add(fresh3 as core::ffi::c_uchar as size_t);
            }
        ...
        unsafe extern "C" fn stbds_siphash_bytes(
                ...
                7 => {
                    data = (data as core::ffi::c_ulong
                        | (((*d.offset(6 as core::ffi::c_int as isize) as size_t)
                            ...
                            << 24 as core::ffi::c_int)
                            as core::ffi::c_ulong) as size_t;
                    current_block_40 = 5645689807412465992;
                }
                6 => {
                    current_block_40 = 5645689807412465992;
                }
                5 => {
                    current_block_40 = 5742864412868380630;
                }
                4 => {
                    current_block_40 = 8702744669900007453;
                }
                3 => {
                    current_block_40 = 15393860117848408854;
                }
                2 => {
                    current_block_40 = 10159363615905050294;
                }
                1 => {
                    current_block_40 = 15656545236210168198;
                }
                0 | _ => {
                    current_block_40 = 1538046216550696469;
                }
            }
            if current_block_40 == 5645689807412465992 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 5742864412868380630 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 8702744669900007453 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(3 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 15393860117848408854 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(2 as core::ffi::c_int as isize) as core::ffi::c_int)
                        << 16 as core::ffi::c_int) as core::ffi::c_ulong)
                    as size_t;
            ...
            if current_block_40 == 10159363615905050294 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(1 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 15656545236210168198 {
                data = (data as core::ffi::c_ulong
        ...
        #[no_mangle]
        pub unsafe extern "C" fn arr_push(num: core::ffi::c_int) {
            let mut arr: *mut core::ffi::c_int = std::ptr::null_mut::<core::ffi::c_int>();
            let mut i: core::ffi::c_int = 0;
            let mut j: core::ffi::c_int = 0;
            if (if !arr.is_null() {
                (*(arr as *mut stbds_array_header).offset(-(1 as core::ffi::c_int as isize))).length
                    as ptrdiff_t
            } else {
                0 as ptrdiff_t
            }) == 0 as ptrdiff_t
            {
                ...
                __assert_fail(b"arrlen(arr)==0\0" as *const u8 as
                        *const core::ffi::c_char,
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/arr_push_lib/src/arr_push_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
                    950 as core::ffi::c_uint, __ASSERT_FUNCTION.as_ptr());
            }
            'c_470: {};
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("arr_push_lib", SOURCE, &[], &[]);
}
