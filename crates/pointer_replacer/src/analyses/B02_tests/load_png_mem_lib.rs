...
pub mod src {
    pub mod lib {
        ...
        impl ::core::marker::Copy for cp_pixel_t {}
        #[automatically_derived]
        impl ::core::clone::Clone for cp_pixel_t {
            #[inline]
            fn clone(&self) -> cp_pixel_t {
        ...
        #[automatically_derived]
        impl ::core::marker::Copy for cp_image_t {}
        #[automatically_derived]
        impl ::core::clone::Clone for cp_image_t {
            #[inline]
            fn clone(&self) -> cp_image_t {
                let _: ::core::clone::AssertParamIsClone<core::ffi::c_int>;
                let _: ::core::clone::AssertParamIsClone<core::ffi::c_int>;
                let _: ::core::clone::AssertParamIsClone<*mut cp_pixel_t>;
                *self
            }
        }
        #[repr(C)]
        ...
        #[automatically_derived]
        impl ::core::marker::Copy for cp_raw_png_t {}
        #[automatically_derived]
        impl ::core::clone::Clone for cp_raw_png_t {
            #[inline]
            fn clone(&self) -> cp_raw_png_t {
                let _: ::core::clone::AssertParamIsClone<*const uint8_t>;
                let _: ::core::clone::AssertParamIsClone<*const uint8_t>;
                *self
            }
        }
        ...
        unsafe extern "C" fn cp_make_pixel(r: uint8_t, g: uint8_t, b: uint8_t) -> cp_pixel_t {
            let mut p: cp_pixel_t = cp_pixel_t {
                r: 0,
                g: 0,
                b: 0,
        ...
        unsafe extern "C" fn cp_ptr(s: *mut cp_state_t) -> *mut core::ffi::c_char {
            if (*s).bits_left & 7 as core::ffi::c_int == 0 {
                ...
                __assert_fail(b"!(s->bits_left & 7)\0" as *const u8 as
                    ...
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/load_png_mem_lib/src/load_png_mem_lib/test_case/src/lib.c\0"
        ...
        unsafe extern "C" fn cp_peak_bits(
            ...
            if (*s).count < num_bits_to_read {
                if (*s).word_index < (*s).word_count {
                    ...
                    (*s).word_index += 1;
                    let word: uint32_t = *((*s).words).offset(fresh21 as isize);
        ...
        unsafe extern "C" fn cp_build(
            ...
            while i < sym_count {
                ...
                if len != 0 as core::ffi::c_int {
                    ...
                    let code: uint32_t = fresh23 as uint32_t;
                    let fresh24 = first[len as usize];
                    first[len as usize] += 1;
                    let slot: uint32_t = fresh24 as uint32_t;
                    ...
                    if ((*s).out).offset(1 as core::ffi::c_int as isize) > (*s).out_end {
                        cp_error_reason =
                            b"Attempted to overwrite out buffer while outputting a symbol.\0"
                                as *const u8
                                as *const core::ffi::c_char;
                        current_block = 7511553701203932871;
                        break;
                    } else {
        ...
        pub unsafe extern "C" fn cp_inflate(
            ...
            loop {
                ...
                match btype {
                    0 => {
                        if cp_stored(s) == 0 {
                            current_block = 5580586526841311861;
                            break;
                        }
                    }
                    1 => {
        ...
        unsafe extern "C" fn cp_paeth(a: uint8_t, b: uint8_t, c: uint8_t) -> uint8_t {
            let p: core::ffi::c_int =
                a as core::ffi::c_int + b as core::ffi::c_int - c as core::ffi::c_int;
            let pa: core::ffi::c_int = abs(p - a as core::ffi::c_int);
            let pb: core::ffi::c_int = abs(p - b as core::ffi::c_int);
            let pc: core::ffi::c_int = abs(p - c as core::ffi::c_int);
            (if pa <= pb && pa <= pc {
                a as core::ffi::c_int
            } else if pb <= pc {
                b as core::ffi::c_int
        ...
        unsafe extern "C" fn cp_make32(s: *const uint8_t) -> uint32_t {
        ...
        unsafe extern "C" fn cp_chunk(
            ...
            let len: uint32_t = cp_make32((*png).p);
            let start: *const uint8_t = (*png).p;
            if memcmp(
                ...
                && len >= minlen
            {
                let offset: core::ffi::c_int = len.wrapping_add(12 as uint32_t) as core::ffi::c_int;
            ...
            if h > 0 as core::ffi::c_int {
                ...
                match fresh5 as core::ffi::c_int {
                    1 => {
                        x = bpp;
                        while x < len {
                            *raw.offset(x as isize) = (*raw.offset(x as isize) as core::ffi::c_int
        ...
        unsafe extern "C" fn cp_depalette(
            ...
            while y < h {
                ...
                let mut x: core::ffi::c_int = 0 as core::ffi::c_int;
                while x < w {
                    let c: core::ffi::c_int = *src as core::ffi::c_int;
                    let r: uint8_t = *plte.offset((c * 3 as core::ffi::c_int) as isize);
                    let g: uint8_t =
                    ...
                    let a: uint8_t = cp_get_alpha_for_indexed_image(c, trns, trns_len);
        ...
        unsafe extern "C" fn cp_get_chunk_byte_length(chunk: *const uint8_t) -> uint32_t {
            cp_make32(chunk.offset(-(8 as core::ffi::c_int as isize)))
        }
        unsafe extern "C" fn cp_out_size(
            img: *mut cp_image_t,
            bpp: core::ffi::c_int,
        ) -> core::ffi::c_int {
            ((*img).w + 1 as core::ffi::c_int) * (*img).h * bpp
        }
        #[no_mangle]
        pub unsafe extern "C" fn load_png_mem(
            png_data: *const uint8_t,
            png_length: core::ffi::c_int,
        ) -> cp_image_t {
            let mut current_block: u64;
            let sig: *const core::ffi::c_char =
                ...
                if ihdr.is_null() {
                    ...
                    if bit_depth != 8 as core::ffi::c_int {
                        ...
                        match color_type {
                            ...
                            _ => {
                                cp_error_reason = b"unknown color type\0" as *const u8
                                    as *const core::ffi::c_char;
                                current_block = 5991241019305096908;
                            }
                        }
                        match current_block {
                            5991241019305096908 => {}
                            _ => {
                                w = (cp_make32(ihdr)).wrapping_add(1 as uint32_t)
                                    as core::ffi::c_int;
                                ...
                                if w < 1 as core::ffi::c_int {
                                    ...
                                    .wrapping_mul(::core::mem::size_of::<cp_pixel_t>())
                                    >= INT_MAX as usize
                                {
                                    cp_error_reason = b"image too large\0" as *const u8
                                        as *const core::ffi::c_char;
                                } else {
                                    pix_bytes = ((w * h) as usize)
                                        .wrapping_mul(::core::mem::size_of::<cp_pixel_t>())
                                        as core::ffi::c_int;
                                    ...
                                    if (img.pix).is_null() {
                                        ...
                                        if compression != 0 {
                                            ...
                                            cp_error_reason = b"interlacing is not supported\0"
                                                as *const u8
                                                as *const core::ffi::c_char;
                                        } else {
                                            first = png.p;
                                            ...
                                            while !idat.is_null() {
                                                let len: uint32_t = cp_get_chunk_byte_length(idat);
                                            ...
                                            while !idat_0.is_null() {
                                                let len_0: uint32_t =
                                                    cp_get_chunk_byte_length(idat_0);
                                                memcpy(
                                            ...
                                            {
                                                cp_error_reason =
                                                    b"only zlib compression method (RFC 1950) is supported\0" as
                                                            *const u8 as *const core::ffi::c_char;
                                            } else if *data.offset(0 as core::ffi::c_int as isize)
                                                as core::ffi::c_int
                                            ...
                                            {
                                                cp_error_reason =
                                                    b"innapropriate window size detected\0"
                                                        as *const u8
                                                        as *const core::ffi::c_char;
                                            ...
                                            {
                                                cp_error_reason =
                                                    b"preset dictionary is present and not supported\0" as
                                                            *const u8 as *const core::ffi::c_char;
                                            } else if cp_out_size(&mut img, 4 as core::ffi::c_int)
                                                < 1 as core::ffi::c_int
                                            {
                                                cp_error_reason = b"invalid image size found\0"
                                                    as *const u8
                                                    as *const core::ffi::c_char;
                                            } else if cp_out_size(&mut img, bpp)
                                                < 1 as core::ffi::c_int
                                            {
                                                cp_error_reason = b"invalid image size found\0"
                                                    as *const u8
                                                ...
                                                out = (img.pix as *mut uint8_t)
                                                    .offset(cp_out_size(
                                                        ...
                                                        as isize)
                                                    .offset(-(cp_out_size(&mut img, bpp) as isize));
                                                if cp_inflate(
                                                ...
                                                ) == 0
                                                {
                                                    ...
                                                    if color_type == 3 as core::ffi::c_int {
                                                        if plte.is_null() {
                                                            cp_error_reason =
                                                                b"color type of indexed requires a PLTE chunk\0" as
                                                                        *const u8 as *const core::ffi::c_char;
                                                            current_block = 5991241019305096908;
                                                        } else {
                                                            let trns_len: uint32_t =
                                                                if !trns.is_null() {
...
fn ownership_analysis_runs() {
    run_ownership_case("load_png_mem_lib", SOURCE);
}
