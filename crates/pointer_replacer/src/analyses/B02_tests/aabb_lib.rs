...
pub mod src {
    pub mod lib {
        ...
        #[no_mangle]
        pub unsafe extern "C" fn c2AABBtoCapsule(
            mut A: c2AABB,
            mut B: c2Capsule,
        ) -> core::ffi::c_int {
            if c2GJK(
                &mut A as *mut c2AABB as *const core::ffi::c_void,
                C2_TYPE_AABB,
                std::ptr::null::<c2x>(),
                &mut B as *mut c2Capsule as *const core::ffi::c_void,
                C2_TYPE_CAPSULE,
                std::ptr::null::<c2x>(),
                std::ptr::null_mut::<c2v>(),
                std::ptr::null_mut::<c2v>(),
                1 as core::ffi::c_int,
        ...
        pub unsafe extern "C" fn c2Collided(
            ...
            match typeA as core::ffi::c_uint {
                ...
                1 => match typeB as core::ffi::c_uint {
                    ...
                    2 => c2AABBtoCapsule(*(A as *mut c2AABB), *(B as *mut c2Capsule)),
                    _ => 0 as core::ffi::c_int,
                },
                2 => match typeB as core::ffi::c_uint {
                    0 => c2CircletoCapsule(*(B as *mut c2Circle), *(A as *mut c2Capsule)),
                    1 => c2AABBtoCapsule(*(B as *mut c2AABB), *(A as *mut c2Capsule)),
                    2 => c2CapsuletoCapsule(*(A as *mut c2Capsule), *(B as *mut c2Capsule)),
                    _ => 0 as core::ffi::c_int,
                },
                _ => 0 as core::ffi::c_int,
            }
        ...
        #[no_mangle]
        pub unsafe extern "C" fn aabb(
            min_x: core::ffi::c_float,
            min_y: core::ffi::c_float,
            max_x: core::ffi::c_float,
            max_y: core::ffi::c_float,
        ) -> core::ffi::c_int {
            let mut result: core::ffi::c_int = 0 as core::ffi::c_int;
            let mut aabb_in: c2AABB = c2AABB {
                min: c2v { x: 0., y: 0. },
                max: c2v { x: 0., y: 0. },
            };
            ...
            circle.r = 20.0f32;
            let mut aabb_0: c2AABB = c2AABB {
                min: c2v { x: 0., y: 0. },
                max: c2v { x: 0., y: 0. },
            };
            aabb_0.min = c2V(-40.0f32, -40.0f32);
            aabb_0.max = c2V(-15.0f32, -15.0f32);
            ...
            result += c2Collided(
                ...
                C2_TYPE_CIRCLE,
                &mut aabb_in as *mut c2AABB as *const core::ffi::c_void,
                C2_TYPE_AABB,
            );
            result += c2Collided(
                &mut aabb_0 as *mut c2AABB as *const core::ffi::c_void,
                C2_TYPE_AABB,
                &mut aabb_in as *mut c2AABB as *const core::ffi::c_void,
                C2_TYPE_AABB,
            ) << 1 as core::ffi::c_int;
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("aabb_lib", SOURCE, &[], &[]);
}
