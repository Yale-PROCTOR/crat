    ...
    pub mod lib {
        ...
        unsafe extern "C" fn stbds_make_hash_index(
                ...
                < (*t).slot_count
            {
                ...
                __assert_fail(b"t->used_count_threshold + t->tombstone_count_threshold < t->slot_count\0"
                    ...
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/sh_geti_lib/src/sh_geti_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
        ...
        pub unsafe extern "C" fn stbds_hash_string(
            ...
            while *str != 0 {
                ...
                .wrapping_add(fresh1 as core::ffi::c_uchar as size_t);
            }
        ...
        unsafe extern "C" fn stbds_siphash_bytes(
                ...
                7 => {
                    data = (data as core::ffi::c_ulong
                        | (((*d.offset(6 as core::ffi::c_int as isize) as size_t)
                            ...
                            << 24 as core::ffi::c_int)
                            as core::ffi::c_ulong) as size_t;
                    current_block_40 = 17167753265414921745;
                }
                6 => {
                    current_block_40 = 17167753265414921745;
                }
                5 => {
                    current_block_40 = 17694301065518352878;
                }
                4 => {
                    current_block_40 = 2517526487469923;
                }
                3 => {
                    current_block_40 = 10913305955572497424;
                }
                2 => {
                    current_block_40 = 16545183894852779452;
                }
                1 => {
                    current_block_40 = 4521442665782964970;
                }
                0 | _ => {
                    current_block_40 = 1538046216550696469;
                }
            }
            if current_block_40 == 17167753265414921745 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 17694301065518352878 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 2517526487469923 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(3 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 10913305955572497424 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(2 as core::ffi::c_int as isize) as core::ffi::c_int)
                        << 16 as core::ffi::c_int) as core::ffi::c_ulong)
                    as size_t;
            ...
            if current_block_40 == 16545183894852779452 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(1 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 4521442665782964970 {
                data = (data as core::ffi::c_ulong
        ...
        #[no_mangle]
        pub unsafe extern "C" fn sh_geti(num: core::ffi::c_int) {
            let mut strmap: *mut C2RustUnnamed = std::ptr::null_mut::<C2RustUnnamed>();
            let s: C2RustUnnamed = C2RustUnnamed {
                key: std::ptr::null_mut::<core::ffi::c_char>(),
                value: 0,
            };
            let mut sa: stbds_string_arena = {
                stbds_string_arena {
                    storage: std::ptr::null_mut::<stbds_string_block>(),
                    remaining: 0,
                    block: 0,
                    mode: 0,
                }
            ...
            while j < 2 as core::ffi::c_int {
                strmap = stbds_hmget_key(
                    strmap as *mut core::ffi::c_void,
                    ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                    b"foo\0" as *const u8 as *const core::ffi::c_char as *mut core::ffi::c_void,
                    ::core::mem::size_of::<*mut core::ffi::c_char>() as size_t,
                    1 as core::ffi::c_int,
                ) as *mut C2RustUnnamed;
                if (*(strmap.offset(-(1 as core::ffi::c_int as isize)) as *mut stbds_array_header)
                    .offset(-(1 as core::ffi::c_int as isize)))
                .temp
                    == -(1 as core::ffi::c_int) as ptrdiff_t
                {
                } else {
                    __assert_fail(b"shgeti(strmap,\"foo\") == -1\0" as *const u8
                            as *const core::ffi::c_char,
                        b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/sh_geti_lib/src/sh_geti_lib/test_case/src/lib.c\0"
                                as *const u8 as *const core::ffi::c_char,
                        956 as core::ffi::c_uint, __ASSERT_FUNCTION.as_ptr());
                }
                'c_7307: {
                    strmap = stbds_hmget_key(
                        strmap as *mut core::ffi::c_void,
                    ...
                    if (*(strmap.offset(-(1 as core::ffi::c_int as isize))
                        as *mut stbds_array_header)
                        .offset(-(1 as core::ffi::c_int as isize)))
                    .temp
                        == -(1 as core::ffi::c_int) as ptrdiff_t
                ...
                if j == 0 as core::ffi::c_int {
                    ...
                    strmap = stbds_shmode_func(
                        ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                        STBDS_SH_ARENA as core::ffi::c_int,
                    ) as *mut C2RustUnnamed;
                }
                strmap = stbds_hmget_key(
                    strmap as *mut core::ffi::c_void,
                    ...
                    == -(1 as core::ffi::c_int) as ptrdiff_t
                {
                    ...
                    __assert_fail(b"shgeti(strmap,\"foo\") == -1\0" as *const u8
                        ...
                        b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/sh_geti_lib/src/sh_geti_lib/test_case/src/lib.c\0"
                                as *const u8 as *const core::ffi::c_char,
                        961 as core::ffi::c_uint, __ASSERT_FUNCTION.as_ptr());
                }
                'c_7069: {
                    strmap = stbds_hmget_key(
                        strmap as *mut core::ffi::c_void,
                ...
                strmap = stbds_hmput_default(
                    strmap as *mut core::ffi::c_void,
                    ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                ) as *mut C2RustUnnamed;
                (*strmap.offset(-(1 as core::ffi::c_int) as isize)).value =
                    -(2 as core::ffi::c_int);
                strmap = stbds_hmget_key(
                    strmap as *mut core::ffi::c_void,
                    ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                    ...
                    == -(1 as core::ffi::c_int) as ptrdiff_t
                {
                    ...
                    __assert_fail(b"shgeti(strmap,\"foo\") == -1\0" as *const u8
                        ...
                        b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/sh_geti_lib/src/sh_geti_lib/test_case/src/lib.c\0"
                                as *const u8 as *const core::ffi::c_char,
                        963 as core::ffi::c_uint, __ASSERT_FUNCTION.as_ptr());
                }
                'c_6821: {
                    strmap = stbds_hmget_key(
                        strmap as *mut core::ffi::c_void,
                ...
                while i < num {
                    strmap = stbds_hmput_key(
                        strmap as *mut core::ffi::c_void,
                        ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                        strkey(i) as *mut core::ffi::c_void,
                        ::core::mem::size_of::<*mut core::ffi::c_char>() as size_t,
                        STBDS_HM_STRING,
                    ) as *mut C2RustUnnamed;
                    (*strmap.offset(
                        (*(strmap.offset(-(1 as core::ffi::c_int as isize))
                            as *mut stbds_array_header)
                            .offset(-(1 as core::ffi::c_int as isize)))
                        .temp,
                    ))
                    ...
                    })
                {
                    printf(
                        ...
                        *strmap.offset(z as isize),
                        (*strmap.offset(z as isize)).value,
                    );
                    z += 1;
                }
                i = 0 as core::ffi::c_int;
                while i < num {
                    if i & 1 as core::ffi::c_int != 0 {
                            ...
                            == -(2 as core::ffi::c_int)
                        {
                            ...
                            __assert_fail(b"shget(strmap, strkey(i)) == -2\0" as
                                        *const u8 as *const core::ffi::c_char,
                                b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/sh_geti_lib/src/sh_geti_lib/test_case/src/lib.c\0"
                                        as *const u8 as *const core::ffi::c_char,
                                971 as core::ffi::c_uint, __ASSERT_FUNCTION.as_ptr());
                        }
                        'c_5089: {
                            strmap = stbds_hmget_key(
                                strmap as *mut core::ffi::c_void,
                            ...
                            == i * 3 as core::ffi::c_int
                        {
                            ...
                            __assert_fail(b"shget(strmap, strkey(i)) == i*3\0" as
                                        *const u8 as *const core::ffi::c_char,
                                b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/sh_geti_lib/src/sh_geti_lib/test_case/src/lib.c\0"
                                        as *const u8 as *const core::ffi::c_char,
                                972 as core::ffi::c_uint, __ASSERT_FUNCTION.as_ptr());
                        }
                        'c_4919: {
                            strmap = stbds_hmget_key(
                                strmap as *mut core::ffi::c_void,
                ...
                while i < num {
                    strmap = stbds_hmdel_key(
                        ...
                        strkey(i) as *mut core::ffi::c_void,
                        ::core::mem::size_of::<*mut core::ffi::c_char>() as size_t,
                        (&mut (*strmap).key as *mut *mut core::ffi::c_char
                            as *mut core::ffi::c_char)
                            .offset_from(strmap as *mut core::ffi::c_char)
                    ...
                    if i & 3 as core::ffi::c_int != 0 {
                            ...
                            == -(2 as core::ffi::c_int)
                        {
                            ...
                            __assert_fail(b"shget(strmap, strkey(i)) == -2\0" as
                                ...
                                b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/sh_geti_lib/src/sh_geti_lib/test_case/src/lib.c\0"
                                        as *const u8 as *const core::ffi::c_char,
                                976 as core::ffi::c_uint, __ASSERT_FUNCTION.as_ptr());
                        }
                        'c_4656: {
                            strmap = stbds_hmget_key(
                                strmap as *mut core::ffi::c_void,
                            ...
                            == i * 3 as core::ffi::c_int
                        {
                            ...
                            __assert_fail(b"shget(strmap, strkey(i)) == i*3\0" as
                                ...
                                b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/sh_geti_lib/src/sh_geti_lib/test_case/src/lib.c\0"
                                        as *const u8 as *const core::ffi::c_char,
                                977 as core::ffi::c_uint, __ASSERT_FUNCTION.as_ptr());
                        }
                        'c_4485: {
                            strmap = stbds_hmget_key(
                                strmap as *mut core::ffi::c_void,
                ...
                while i < num {
                        ...
                        == -(2 as core::ffi::c_int)
                    {
                        ...
                        __assert_fail(b"shget(strmap, strkey(i)) == -2\0" as
                            ...
                            b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/sh_geti_lib/src/sh_geti_lib/test_case/src/lib.c\0"
                                    as *const u8 as *const core::ffi::c_char,
                            981 as core::ffi::c_uint, __ASSERT_FUNCTION.as_ptr());
                    }
                    'c_398: {
                        strmap = stbds_hmget_key(
                            strmap as *mut core::ffi::c_void,
                ...
                if !strmap.is_null() {
                    stbds_hmfree_func(
                        strmap.offset(-(1 as core::ffi::c_int as isize)) as *mut core::ffi::c_void,
                        ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                    );
                };
                strmap = std::ptr::null_mut::<C2RustUnnamed>();
                j += 1;
            }
        }
    }
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("sh_geti_lib", SOURCE, &[], &[]);
}
