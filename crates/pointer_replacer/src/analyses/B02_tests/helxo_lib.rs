...
pub mod src {
    pub mod lib {
        ...
        unsafe extern "C" fn stbds_make_hash_index(
                ...
                < (*t).slot_count
            {
                ...
                __assert_fail(b"t->used_count_threshold + t->tombstone_count_threshold < t->slot_count\0"
                    ...
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/helxo_lib/src/helxo_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
        ...
        unsafe extern "C" fn stbds_siphash_bytes(
                ...
                7 => {
                    data = (data as core::ffi::c_ulong
                        | (((*d.offset(6 as core::ffi::c_int as isize) as size_t)
                            ...
                            << 24 as core::ffi::c_int)
                            as core::ffi::c_ulong) as size_t;
                    current_block_40 = 12533541166356859325;
                }
                6 => {
                    current_block_40 = 12533541166356859325;
                }
                5 => {
                    current_block_40 = 3067474333875804384;
                }
                4 => {
                    current_block_40 = 14597459921621826422;
                }
                3 => {
                    current_block_40 = 10680588458414341081;
                }
                2 => {
                    current_block_40 = 2597896670383610064;
                }
                1 => {
                    current_block_40 = 12058130057418514967;
                }
                0 | _ => {
                    current_block_40 = 1538046216550696469;
                }
            }
            if current_block_40 == 12533541166356859325 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 3067474333875804384 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 14597459921621826422 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(3 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 10680588458414341081 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(2 as core::ffi::c_int as isize) as core::ffi::c_int)
                        << 16 as core::ffi::c_int) as core::ffi::c_ulong)
                    as size_t;
            ...
            if current_block_40 == 2597896670383610064 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(1 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 12058130057418514967 {
                data = (data as core::ffi::c_ulong
        ...
        #[no_mangle]
        pub unsafe extern "C" fn helxo(letter: core::ffi::c_char) {
            let mut hash: *mut C2RustUnnamed = std::ptr::null_mut::<C2RustUnnamed>();
            let mut name: [core::ffi::c_char; 4] =
                [b'j' as i8, b'e' as i8, b'n' as i8, b'\0' as i8];
            hash = stbds_hmput_key(
                hash as *mut core::ffi::c_void,
                ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                b"bob\0" as *const u8 as *const core::ffi::c_char as *mut core::ffi::c_void,
                ::core::mem::size_of::<*mut core::ffi::c_char>() as size_t,
                STBDS_HM_STRING,
            ) as *mut C2RustUnnamed;
            (*hash.offset(
                (*(hash.offset(-(1 as core::ffi::c_int as isize)) as *mut stbds_array_header)
                    .offset(-(1 as core::ffi::c_int as isize)))
                .temp,
            ))
            .value = 'h' as i32 as core::ffi::c_char;
            hash = stbds_hmput_key(
                hash as *mut core::ffi::c_void,
                ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                b"sally\0" as *const u8 as *const core::ffi::c_char as *mut core::ffi::c_void,
                ::core::mem::size_of::<*mut core::ffi::c_char>() as size_t,
                STBDS_HM_STRING,
            ) as *mut C2RustUnnamed;
            (*hash.offset(
            ...
            .value = 'e' as i32 as core::ffi::c_char;
            hash = stbds_hmput_key(
                hash as *mut core::ffi::c_void,
                ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                b"fred\0" as *const u8 as *const core::ffi::c_char as *mut core::ffi::c_void,
                ::core::mem::size_of::<*mut core::ffi::c_char>() as size_t,
                STBDS_HM_STRING,
            ) as *mut C2RustUnnamed;
            (*hash.offset(
            ...
            .value = 'l' as i32 as core::ffi::c_char;
            hash = stbds_hmput_key(
                hash as *mut core::ffi::c_void,
                ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                b"jen\0" as *const u8 as *const core::ffi::c_char as *mut core::ffi::c_void,
                ::core::mem::size_of::<*mut core::ffi::c_char>() as size_t,
                STBDS_HM_STRING,
            ) as *mut C2RustUnnamed;
            (*hash.offset(
            ...
            .value = 'x' as i32 as core::ffi::c_char;
            hash = stbds_hmput_key(
                hash as *mut core::ffi::c_void,
                ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                b"doug\0" as *const u8 as *const core::ffi::c_char as *mut core::ffi::c_void,
                ::core::mem::size_of::<*mut core::ffi::c_char>() as size_t,
                STBDS_HM_STRING,
            ) as *mut C2RustUnnamed;
            (*hash.offset(
            ...
            .value = 'o' as i32 as core::ffi::c_char;
            hash = stbds_hmput_key(
                hash as *mut core::ffi::c_void,
                ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                ...
                })
            {
                printf(
                    ...
                    *hash.offset(z as isize),
                    (*hash.offset(z as isize)).value as core::ffi::c_int,
                );
                z += 1;
            }
            if !hash.is_null() {
                stbds_hmfree_func(
                    hash.offset(-(1 as core::ffi::c_int as isize)) as *mut core::ffi::c_void,
                    ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                );
            };
            hash = std::ptr::null_mut::<C2RustUnnamed>();
        }
    }
}
"####;
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("helxo_lib", SOURCE, &[], &[]);
}
