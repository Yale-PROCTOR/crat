...
pub mod src {
    pub mod lib {
        ...
        pub const __ASSERT_FUNCTION: [core::ffi::c_char; 17] = [
            b'v' as i8,
            b'o' as i8,
            b'i' as i8,
            b'd' as i8,
        ...
        unsafe extern "C" fn stbds_make_hash_index(
                ...
                < (*t).slot_count
            {
                ...
                __assert_fail(b"t->used_count_threshold + t->tombstone_count_threshold < t->slot_count\0"
                    ...
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/intput_lib/src/intput_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
        ...
        unsafe extern "C" fn stbds_siphash_bytes(
                ...
                7 => {
                    data = (data as core::ffi::c_ulong
                        | (((*d.offset(6 as core::ffi::c_int as isize) as size_t)
                            ...
                            << 24 as core::ffi::c_int)
                            as core::ffi::c_ulong) as size_t;
                    current_block_40 = 6441241985455142214;
                }
                6 => {
                    current_block_40 = 6441241985455142214;
                }
                5 => {
                    current_block_40 = 7071795781566339191;
                }
                4 => {
                    current_block_40 = 16822028521240473914;
                }
                3 => {
                    current_block_40 = 839997854500304650;
                }
                2 => {
                    current_block_40 = 1590164958260554083;
                }
                1 => {
                    current_block_40 = 15213321275177340193;
                }
                0 | _ => {
                    current_block_40 = 1538046216550696469;
                }
            }
            if current_block_40 == 6441241985455142214 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 7071795781566339191 {
                data = (data as core::ffi::c_ulong
            ...
            if current_block_40 == 16822028521240473914 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(3 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 839997854500304650 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(2 as core::ffi::c_int as isize) as core::ffi::c_int)
                        << 16 as core::ffi::c_int) as core::ffi::c_ulong)
                    as size_t;
            ...
            if current_block_40 == 1590164958260554083 {
                data = (data as core::ffi::c_ulong
                    | ((*d.offset(1 as core::ffi::c_int as isize) as core::ffi::c_int)
            ...
            if current_block_40 == 15213321275177340193 {
                data = (data as core::ffi::c_ulong
        ...
        #[no_mangle]
        pub unsafe extern "C" fn intput(num: core::ffi::c_int) {
            ...
            intmap = stbds_hmput_key(
                ...
                [num].as_mut_ptr() as *mut core::ffi::c_void,
            ...
            intmap = stbds_hmput_key(
                intmap as *mut core::ffi::c_void,
                ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                [11 as core::ffi::c_int].as_mut_ptr() as *mut core::ffi::c_void,
                ::core::mem::size_of::<core::ffi::c_int>() as size_t,
                0 as core::ffi::c_int,
            ) as *mut C2RustUnnamed;
            (*intmap.offset(
            ...
            intmap = stbds_hmput_key(
                intmap as *mut core::ffi::c_void,
                ::core::mem::size_of::<C2RustUnnamed>() as size_t,
                [9 as core::ffi::c_int].as_mut_ptr() as *mut core::ffi::c_void,
                ::core::mem::size_of::<core::ffi::c_int>() as size_t,
                0 as core::ffi::c_int,
            ) as *mut C2RustUnnamed;
            (*intmap.offset(
                ...
                == num
            {
                ...
                __assert_fail(b"hmget(intmap, 9) == num\0" as *const u8 as
                        *const core::ffi::c_char,
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/intput_lib/src/intput_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
                ...
                == 3 as core::ffi::c_int
            {
                ...
                __assert_fail(b"hmget(intmap, 11) == 3\0" as *const u8 as
                        *const core::ffi::c_char,
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/intput_lib/src/intput_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
                    954 as core::ffi::c_uint, __ASSERT_FUNCTION.as_ptr());
            }
            'c_2662: {
                intmap = stbds_hmget_key(
                    intmap as *mut core::ffi::c_void,
                ...
                == 7 as core::ffi::c_int
            {
                ...
                __assert_fail(b"hmget(intmap, num) == 7\0" as *const u8 as
                        *const core::ffi::c_char,
                    b"/home/ubuntu/Test-Corpus/Public-Tests/B02_organic/intput_lib/src/intput_lib/test_case/src/lib.c\0"
                            as *const u8 as *const core::ffi::c_char,
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("intput_lib", SOURCE, &[], &[]);
}
