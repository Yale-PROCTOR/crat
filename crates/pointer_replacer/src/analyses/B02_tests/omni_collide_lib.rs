        ...
        pub unsafe extern "C" fn c2Collided(
            ...
            match typeA as core::ffi::c_uint {
                1 => match typeB as core::ffi::c_uint {
                    1 => c2CircletoCircle(*(A as *mut c2Circle), *(B as *mut c2Circle)),
                    2 => c2CircletoAABB(*(A as *mut c2Circle), *(B as *mut c2AABB)),
                    0 => c2CircletoCapsule(*(A as *mut c2Circle), *(B as *mut c2Capsule)),
                    _ => 0 as core::ffi::c_int,
                },
                2 => match typeB as core::ffi::c_uint {
                    1 => c2CircletoAABB(*(B as *mut c2Circle), *(A as *mut c2AABB)),
                    2 => c2AABBtoAABB(*(A as *mut c2AABB), *(B as *mut c2AABB)),
                    0 => c2AABBtoCapsule(*(A as *mut c2AABB), *(B as *mut c2Capsule)),
                    _ => 0 as core::ffi::c_int,
                },
                0 => match typeB as core::ffi::c_uint {
                    1 => c2CircletoCapsule(*(B as *mut c2Circle), *(A as *mut c2Capsule)),
                    2 => c2AABBtoCapsule(*(B as *mut c2AABB), *(A as *mut c2Capsule)),
                    0 => c2CapsuletoCapsule(*(A as *mut c2Capsule), *(B as *mut c2Capsule)),
                    _ => 0 as core::ffi::c_int,
                },
                _ => 0 as core::ffi::c_int,
            }
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("omni_collide_lib", SOURCE, &[], &[]);
}
