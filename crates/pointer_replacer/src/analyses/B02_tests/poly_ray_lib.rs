...
pub mod src {
    pub mod lib {
        ...
        pub unsafe extern "C" fn c2xIdentity() -> c2x {
            let mut x: c2x =
                c2x { p: c2v { x: 0., y: 0. }, r: c2r { c: 0., s: 0. } };
            x.p =
                c2V(0 as core::ffi::c_int as core::ffi::c_float,
                    0 as core::ffi::c_int as core::ffi::c_float);
            x.r = c2RotIdentity();
        ...
        #[no_mangle]
        pub unsafe extern "C" fn c2RaytoPoly(mut A: c2Ray,
            mut B: *const c2Poly, mut bx_ptr: *const c2x,
            mut out: *mut c2Raycast) -> core::ffi::c_int {
            let mut bx: c2x =
                if !bx_ptr.is_null() { *bx_ptr } else { c2xIdentity() };
            let mut p: c2v = c2MulxvT(bx, A.p);
            let mut d: c2v = c2MulrvT(bx.r, A.d);
            let mut lo: core::ffi::c_float =
                0 as core::ffi::c_int as core::ffi::c_float;
            let mut hi: core::ffi::c_float = A.t;
            let mut index: core::ffi::c_int = !(0 as core::ffi::c_int);
            let mut i: core::ffi::c_int = 0 as core::ffi::c_int;
            while i < (*B).count {
                let mut num: core::ffi::c_float =
                    c2Dot((*B).norms[i as usize],
                        c2Sub((*B).verts[i as usize], p));
                let mut den: core::ffi::c_float =
                    c2Dot((*B).norms[i as usize], d);
                if den == 0 as core::ffi::c_int as core::ffi::c_float &&
                        num < 0 as core::ffi::c_int as core::ffi::c_float {
                    return 0 as core::ffi::c_int
                } else if den < 0 as core::ffi::c_int as core::ffi::c_float &&
                        num < lo * den {
                    lo = num / den;
                    index = i;
                } else if den > 0 as core::ffi::c_int as core::ffi::c_float &&
                ...
                if hi < lo { return 0 as core::ffi::c_int; }
                i += 1;
            }
        ...
        pub unsafe extern "C" fn c2CastRay(mut A: c2Ray,
            mut B: *const core::ffi::c_void, mut bx: *const c2x,
            mut typeB: C2_TYPE, mut out: *mut c2Raycast) -> core::ffi::c_int {
            match typeB as core::ffi::c_uint {
                ...
                3 => return c2RaytoPoly(A, B as *const c2Poly, bx, out),
                _ => {}
            }
            return 0 as core::ffi::c_int;
        }
        #[no_mangle]
        pub unsafe extern "C" fn poly_ray(mut cast1: *mut c2Raycast,
            mut cast2: *mut c2Raycast) -> core::ffi::c_int {
            ...
            p.verts[0 as core::ffi::c_int as usize] = c2V(0.875f32, -11.5f32);
            p.verts[1 as core::ffi::c_int as usize] = c2V(0.875f32, 11.5f32);
            p.verts[2 as core::ffi::c_int as usize] = c2V(-0.875f32, 11.5f32);
            p.verts[3 as core::ffi::c_int as usize] =
                c2V(-0.875f32, -11.5f32);
            p.norms[0 as core::ffi::c_int as usize] =
                c2V(1 as core::ffi::c_int as core::ffi::c_float,
                    0 as core::ffi::c_int as core::ffi::c_float);
            p.norms[1 as core::ffi::c_int as usize] =
                c2V(0 as core::ffi::c_int as core::ffi::c_float,
                    1 as core::ffi::c_int as core::ffi::c_float);
            p.norms[2 as core::ffi::c_int as usize] =
                c2V(-(1 as core::ffi::c_int) as core::ffi::c_float,
                    0 as core::ffi::c_int as core::ffi::c_float);
            p.norms[3 as core::ffi::c_int as usize] =
                c2V(0 as core::ffi::c_int as core::ffi::c_float,
                    -(1 as core::ffi::c_int) as core::ffi::c_float);
            ...
            let mut ray0: c2Ray =
                {
                    let mut init =
                        c2Ray {
                            p: {
                                let mut init = c2v { x: -3.869416f32, y: 13.0693407f32 };
                                init
                            },
                            d: {
                                let mut init =
                            ...
                            t: 4 as core::ffi::c_int as core::ffi::c_float,
                        };
                    init
                };
            let mut ray1: c2Ray =
            ...
            hit +=
                c2CastRay(ray0,
                    &mut p as *mut c2Poly as *const core::ffi::c_void,
                    0 as *const c2x, C2_TYPE_POLY, cast1);
            hit +=
                c2CastRay(ray1,
                        &mut p as *mut c2Poly as *const core::ffi::c_void,
                        0 as *const c2x, C2_TYPE_POLY, cast2) <<
                    1 as core::ffi::c_int;
            return hit;
        }
    }
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("poly_ray_lib", SOURCE, &[], &[]);
}
