...
pub mod src {
    pub mod mdcore {
        ...
        pub const INIT_mul: core::ffi::c_int = 1 as core::ffi::c_int;
        #[no_mangle]
        ...
        unsafe extern "C" fn accum_mul(n: core::ffi::c_int) -> core::ffi::c_int {
            let mut acc: core::ffi::c_int = INIT_mul;
            match n {
                1 => {
                    acc *= 0 as core::ffi::c_int + 1 as core::ffi::c_int;
                }
                2 => {
                    acc *= 0 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 1 as core::ffi::c_int + 1 as core::ffi::c_int;
                }
                3 => {
                    acc *= 0 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 1 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 2 as core::ffi::c_int + 1 as core::ffi::c_int;
                }
                4 => {
                    acc *= 0 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 1 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 2 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 3 as core::ffi::c_int + 1 as core::ffi::c_int;
                }
                5 => {
                    acc *= 0 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 1 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 2 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 3 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 4 as core::ffi::c_int + 1 as core::ffi::c_int;
                }
                6 => {
                    acc *= 0 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 1 as core::ffi::c_int + 1 as core::ffi::c_int;
                    ...
                    acc *= 3 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 4 as core::ffi::c_int + 1 as core::ffi::c_int;
                    acc *= 5 as core::ffi::c_int + 1 as core::ffi::c_int;
                }
                0 | _ => {}
            }
            acc
        ...
        pub unsafe extern "C" fn helper_call(
            ...
            let r: core::ffi::c_int = op_mul(a, b);
            let mut acc: core::ffi::c_int = INIT_mul;
            acc *= 0 as core::ffi::c_int + 1 as core::ffi::c_int;
            acc *= 1 as core::ffi::c_int + 1 as core::ffi::c_int;
            acc *= 2 as core::ffi::c_int + 1 as core::ffi::c_int;
        ...
        pub unsafe extern "C" fn use_generated(n: core::ffi::c_int) -> core::ffi::c_int {
            let r: core::ffi::c_int = accum_mul(n);
            printf(
                b"gen.acc=%d\n\0" as *const u8 as *const core::ffi::c_char,
                r,
            );
    ...
    pub mod mdmain {
        ...
        pub const REPEAT: core::ffi::c_int = 4 as core::ffi::c_int;
        ...
        unsafe fn main_0(
            ...
            let r_call: core::ffi::c_int = op_mul(a, b);
            let mut acc: core::ffi::c_int = INIT_mul;
            acc *= 0 as core::ffi::c_int + 1 as core::ffi::c_int;
            acc *= 1 as core::ffi::c_int + 1 as core::ffi::c_int;
            acc *= 2 as core::ffi::c_int + 1 as core::ffi::c_int;
...
fn ownership_analysis_runs() {
    run_ownership_case_with_box_candidates("macrodepth_mul_4", SOURCE, &[], &[]);
}
