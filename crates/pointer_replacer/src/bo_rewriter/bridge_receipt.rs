...
pub(crate) struct BridgeSiteKey {
    pub(crate) owner_class: LocalDefId,
...
impl BridgeSiteKey {
    pub(crate) fn receipt_key(&self) -> String {
        format!(
            "{}:{}:{}:{}:{}:{}:{}:{}:{}",
            self.owner_class.local_def_index.as_u32(),
    ...
    fn for_test(label: &str) -> Self {
        Self {
            owner_class: rustc_hir::def_id::CRATE_DEF_ID,
    ...
    let mut rows = events
        ...
        .map(|event| {
            ...
            format!(
                "{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}",
                site.receipt_key(),
                site.owner_class.local_def_index.as_u32(),
